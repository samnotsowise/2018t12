    ...
    public class MainScreen: GameScreen {
        ...
        public override void Update(GameTime gameTime, bool otherScreenHasFocus, bool coveredByOtherScreen) {
            ...
            else
            {
                ...
                if (this.playerPaddle.rect.Contains(this.puck.rect) || this.networkPaddle.rect.Contains(this.puck.rect))
                {
        ...
        public override void Draw(GameTime gameTime) {
            ...
            //if connected then draw opponents paddle
            if (ScreenManager.blnConnected)
            {
                ScreenManager.SpriteBatch.Draw(this.networkPaddle.texture, this.networkPaddle.rect, Color.White);
            }
