...
namespace FarseerGames.AirHockeyGame
{
    ...
    class NetworkPaddle : PaddleObject
    {
        ...
        public NetworkPaddle(Texture2D t, int c, Vector2 iP, PhysicsSimulator pS)
        {
        ...
        public void UpdatePaddle(float networkX, float networkY)
        {
            //Saves multiple calls to GetState later on
            this.currentMouse = new Vector2(networkX, networkY);
