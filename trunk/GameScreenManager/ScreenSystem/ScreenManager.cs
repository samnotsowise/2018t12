...
namespace GameScreenManager.ScreenSystem {
    ...
    public class ScreenManager: DrawableGameComponent {
        ...
        public void StartGame(char gameType) {
            ...
            switch(gameType) {
                ...
                case 'f': this.gameType = GameType.FindGame;
                    ...
                    // GT - Wait half a second to allow server to start up if run via Visual Studio
                    System.Threading.Thread.Sleep(500);

                    // GT - FIND NETWORK GAME
                    findNetworkGame();
                    
                    break;
                case 'm': 
                    this.gameType = GameType.StartMultiplayer;
                    //GT - STAT NETWORK GAME
                    startNetworkGame();
                    break;
            }
        }

        #region start or find network game
        ...
        #region network update methods
        public void handleServerUpdate(float x, float y)
        {
                ...
                while (server.ReadMessage(buffer, out type, out sender))
                {
                    switch (type)
                    {
                        case NetMessageType.Data:
                            ...
                            sendBuffer.Write(new Vector2(x, y));
        ...
        public void handleClientUpdate(float x, float y)
        {
        ...
        public override void Draw(GameTime gameTime) {
            ...
            // GT - DRAW OUT NETWORK MSG FOR TESTING PURPOSES
