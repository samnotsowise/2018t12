...
namespace AirHockeyGame
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        protected virtual void InitializeParticle(Particle p, Vector2 where)
        {
            ...
            float lifetime =
                AirHockey.RandomBetween(minLifetime, maxLifetime);
            float scale =
                AirHockey.RandomBetween(minScale, maxScale);
            float rotationSpeed =
                AirHockey.RandomBetween(minRotationSpeed, maxRotationSpeed);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            foreach (Particle p in particles)
            {
                ...
                game.ScreenManager.SpriteBatch.Draw(texture, p.Position, null, color,
