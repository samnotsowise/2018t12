...
namespace AirHockeyGame {
    ...
    public class AirHockey: Game {
        ...
        public AirHockey() {
            ...
            stars = new StarParticleSystem(this, 1);
            ...
            if(ScreenManager.AddParticles) {
                switch(ScreenManager.ParticleTypeToAdd) {
                    ...
                    case ScreenManager.ParticleType.Smoke:
                        ...
                        break;
                    case ScreenManager.ParticleType.Stars:
                        stars.AddParticles(ScreenManager.ParticleSourcePosition);
                        break;
                }
